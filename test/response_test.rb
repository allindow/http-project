...
class ResponseTest < Minitest::Test
  ...
  def setup
    ...
    @parsed_request_info = ["Verb: GET", "Path: /", "Protocol: HTTP/1.1", "Host: 127.0.0.1", "Port: 9292", "Origin: 127.0.0.1", "Accept: */*"]
  end

  def test_formatter_provides_html_formatting
    assert_equal   "<html><head></head><body><pre>" + "hello" + "</pre></body></html>", response.formatter("hello")
  end
